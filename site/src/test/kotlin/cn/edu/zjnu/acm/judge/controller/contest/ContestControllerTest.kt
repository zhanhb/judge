...
class ContestControllerTest {
     ...
     *
     * @see ContestController.standingHtml
     */
    @Test
    @Throws(Exception::class)
    fun testStandingHtml() {
        log.info("standingHtml")
        val contestId = mockDataService!!.contest().id
        val locale = Locale.getDefault()
        val result = mvc!!.perform(get("/contests/{contestId}/standing", contestId)
                .locale(locale))
    ...
    fun testIndex() {
        ...
        val result = mvc!!.perform(get("/contests/{contestId}", contestId))
